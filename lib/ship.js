		...
		createProperty: function(property) {
			...
			return function() {
				...
				Array.prototype.forEach.call(arguments, function(arg) {
					if(arg && typeof(arg)=='object' && arg.ship_promise__)
						arg = arg.ship_promise__;
					args.push(arg);
				});
...
function create_invocation_promise(receiver_promise, property, args, sync) {
	...
	args.forEach(function(arg) {
		if(!arg || typeof(arg) != 'object' || !arg.ship_) // literal
			arg = {value: arg, queue: receiver_promise.queue, ship_: true, notifications: []};
		if(arg.queue != receiver_promise.queue)
			throw new Error("Mixing separate ships is not currently supported");
